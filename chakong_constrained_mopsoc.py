...
def g1(x):
    a = [- 20.0 + 0.2 * i for i in x]
    return 225.0 - (a[0] ** 2.0 + a[1] ** 2.0)


def g2(x):
    a = [- 20.0 + 0.2 * i for i in x]
    return a[0] - 3.0 * a[1] + 10.0
...
class PSOCategorical:
    ...
    def run(self):
        ...
        for iteration in range(self.n_iterations):
            ...
            with open("chakong3_1.dat", "a") as term:
            ...
            if iteration % 5 == 0:
                ...
                with open("chakong3_5.dat", "a") as term:
            ...
            if iteration % 10 == 0:
                ...
                with open("chakong3_10.dat", "a") as term:
            ...
            with open("chakong3_mopsoc.dat", "a") as out:
