...
class PSOCategorical:
    def __init__(self, n_particles, scaling_factor, function1, function2, function3):
        self.n_functions = 3
    ...
    def run(self):
        ...
        for iteration in range(self.n_iterations):
            ...
            self.fitness = Parallel(n_jobs=-1)(delayed(fitness_function)(sample, [self.function1, self.function2, self.function3]) for sample in self.samples)
            self.fitness_and_samples = list(zip(self.fitness, self.samples))
...
if __name__ == '__main__':
    opt = PSOCategorical(20, 0.5, functi1, functi2, functi3)
    opt.run()
