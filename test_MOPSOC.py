...
class PSOCategorical:
    ...
    def run(self):
        ...
        for iteration in range(self.n_iterations):
            ...
            # if weight1 < 1:
            #     weight1 = 0.0
            weight1 = abs(sin(4.0 * 2.0 * pi * iteration / self.n_iterations))
            weight2 = 1.0 - weight1
            ...
            with open("test4_1.dat", "a") as term:
            ...
            if iteration % 5 == 0:
                ...
                with open("test4_5.dat", "a") as term:
            ...
            if iteration % 10 == 0:
                ...
                with open("test4_10.dat", "a") as term:
            ...
            with open("test_mopsoc4.dat", "a") as out:
...
if __name__ == '__main__':
    opt = PSOCategorical(20, 0.5, functi1, functi2)
    opt.run()
